...
import MealPlannerPage from "./components/MealPlannerPage.js";
...
function App() {
  ...
  const renderPage = () => {
    ...
    if (page === "recipes") {
      return React.createElement(RecipesPage, {
        setPage,
        recipeToOpen,
        setRecipeToOpen,
      });
    ...
    if (page === "planner") {
      return React.createElement(MealPlannerPage, {
        setPage,
        openRecipePage,
      });
    }
  ...
  return React.createElement(
    ...
    [
      React.createElement("div", { key: "titleBar", className: "title-bar" }, [
